...
description: Use when a user provides a business functional structure document and needs a standalone Basic operational React/Vite application generated per the platform UI specification, with product-manager HTML preview confirmation and publish to the demo environment.
---
